/*
Модуль  - добавляет панель рисования различных фигур
В активном состоянии устанавливает свойство operationWith = "draw-figure"
*/


(function(){	
  var html = `
  								 <div data-draw_figure_panel="container"  class="form-group" name="data-draw_figure_panel">
									<label for="exampleFormControlInput1" style="font-size: 15px;">Рисовать фигуру</label>
									<div class="form-row">
