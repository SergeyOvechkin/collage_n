...
В качестве подсказок, при наведении и удерживании курсора над большинством кнопок появляется кратнкое описание функции данной кнопки, на которые следует ориентироваться.
